...
const CreateCourseMain = () => {
  ...
  const handleSave = async (status: "draft" | "published") => {
    if (!canSubmit) {
      toast.error(
        "Please fill required fields (title, description, and price for paid course)."
      );
      return;
    }
    ...
    try {
      ...
      const payload: CoursePayload = {
        ...
        instructorName: author.trim() || undefined,
        price: courseType === "free" ? 0 : Number(regularPrice || 0),
        oldPrice: salePrice ? Number(salePrice) : undefined,
        status,
      };
  ...
  const courseSections = [
    ...
    { id: "Three", title: "Course Attachments", component: CourseAttachment },
    {
      ...
      component: () => (
        <AddProductForm
          ...
          onPriceChange={(field: string, value: string) => {
    ...
    {
      id: "Seven",
      title: "Featured Image and Video Lessons",
      component: FeatureImageOrVideo,
    },
