...
const CourseCurriculum: React.FC<CourseCurriculumProps> = ({ roadmap }) => {
    const curriculum = roadmap ?? curriculamData;
                                    ...
                                    {section.lectures.map((lecture, lectureIndex) => (
                                        <Link key={lectureIndex} href="#" className="bd-course-curriculum-content d-flex-between">
                                            ...
                                            <div className="bd-course-curriculum-meta d-flex-items gap-10">
                                                {lecture.duration && <span className="duration">{lecture.duration}</span>}
