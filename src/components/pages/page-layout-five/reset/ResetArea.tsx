import ResetForm from '@/form/auth/reset-form';
import Image from 'next/image';
import Link from 'next/link';
import React from 'react';
import Logo from '../../../../../public/assets/images/logo/logo.svg';

interface ResetAreaProps {
    token: string;
}

const ResetArea = ({ token }: ResetAreaProps) => {
    return (
        <>
                ...
                <div className="row justify-content-center align-items-center h100p">
                    <div className="col-xxl-7 col-xl-9 col-lg-6 col-md-6 col-sm-8 col-12">
                        <div className="bd-authentication-form-wrapper">
                            ...
                            <h3 className="title mb-10">Set New Password</h3>
                            ...
                            <div className="bd-sign-up-label underline-two text-center">
                                Remember your password?<Link href="/sign-in" className="sign-link"> Sign in</Link>
                            </div>
                        </div>
                    </div>
                </div>
