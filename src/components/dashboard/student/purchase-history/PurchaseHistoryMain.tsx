                 ...
                 <div className="bd-dashboard-table table-responsive mt-30">
                    {loading ? (
                        ...
                        <div className="alert alert-warning text-center">
                            <i className="fa-solid fa-exclamation-triangle"></i> Unable to load purchase history. Please try again later.
                        </div>
                    ) : purchases.length === 0 ? (
                        <div className="text-center py-5">
                            <i className="fa-solid fa-receipt fa-3x mb-3 text-muted"></i>
                            <h5>No Purchase History Yet</h5>
                            <p className="text-muted">Your purchases will appear here after you complete an order.</p>
                        </div>
                    ) : (
                                ...
                                {purchases.map((purchase, index) => {
                                    ...
                                    return (
                                        <tr key={`${purchase.course}-${purchase.date}-${index}`}>
                                            ...
                                            <td>
                                                <div className={`bd-badge ${badge.className}`}>{badge.text}</div>
                                            </td>
                                            <td>
