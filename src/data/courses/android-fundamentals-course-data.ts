...
export interface AndroidLectureVideo { title: string; url: string; type?: "video" | "short"; }
export interface AndroidFundamentalsSection { title: string; lectures: { title: string; duration: string; videos?: AndroidLectureVideo[]; }[]; }

export const androidFundamentalsCourse: ICourse = {
  id: 37, badge: "FREE", badgeClass: "badge-primary", image: courseBg3, imageClassName: "bg-3", instructorImage: instructorImg2, instructorImageClassName: "right", courseTextContent: true,
  title: "Android App Development with Java/XML", courseName: "Android", smallText: "Fundamentals", spacingClass: "mb--5", courseTag: "Free Course", lessons: 32, students: 0,
  courseDescription: "Understand Android fundamentals from the ecosystem and SDK to Android Studio, Java/XML UI, core Android components, runtime, data transfer, database, and AndroidManifest.xml.", rating: 5, price: 0, discount: 0, quantity: 0,
  certificateBadge: "Android Fundamentals Badge", advancedTitle: "Android App Development — Beginner to Advanced", level: "Fundamentals",
  details: "A focused foundation course for understanding Android development with Java and XML before moving into real-world project-based Android development.",
  courseList: ["Android Ecosystem", "Android SDK & Packages", "Android Studio & Project Structure", "Java & XML UI", "Activity, Lifecycle, Intent & Context", "Android Components", "Runtime & Debugging", "Data Transfer", "Database & AndroidManifest.xml"],
  instructorName: "Enamul Huq", category: ["App Development", "Android", "Java", "XML"], previewVideoId: "jnl_DlXG6Tk",
};

export const androidFundamentalsRoadmap: AndroidFundamentalsSection[] = [
  { title: "Android Ecosystem", lectures: [
  ...
  { title: "Android Studio & Project Structure", lectures: [
  ...
  { title: "Activity & Core Components", lectures: [
    ...
    { title: "Android Activity Lifecycle Explained with a Stage Actor", duration: "", videos: [{ title: "Activity Lifecycle", url: "https://www.youtube.com/shorts/etbvw3wxhsU", type: "short" }] },
  ...
  { title: "Android Components", lectures: [
  ...
  { title: "Runtime & Debugging", lectures: [
  ...
  { title: "Database & AndroidManifest.xml", lectures: [
